...
TEST(PZ90toWGS84Test, Equivalence){
    ...
    EXPECT_GT(30, testObject->getCoordinateObjectWGS84().getGeodeticLatitudeB() * 180 / M_PI);
    EXPECT_LT(40, testObject->getCoordinateObjectWGS84().getGeodeticLongitudeL() * 180 / M_PI);
}
