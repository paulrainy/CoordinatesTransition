...
protected:
    ...
    double sk42_X; //x по ск42
    double sk42_Y; //y по ск42
    ...
    std::vector <double> array_sk42_X; //вектор с х координатами ск42
    std::vector <double> array_sk42_Y; //вектор с y координатами ск42
